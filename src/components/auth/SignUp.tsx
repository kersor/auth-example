  ...
  return (
    <div className='flex flex-col justify-center items-center w-full'>
      ...
      <div className='mt-[56px] max-w-[448px] w-full'>
        ...
        <div className='mt-[14px] text-right text-[#3E3E3E] text-[14px] max-600px:text-[12px]цц'>Forgot password? <span className='text-[#121212] font-medium'>Change now</span></div>
